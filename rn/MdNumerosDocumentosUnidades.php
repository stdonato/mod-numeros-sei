<?php
  ...
  switch($_GET['acao']){
    ...
    case 'MdNumerosDocumentosUnidades':
      $strTitulo = 'SEI! em N&uacute;meros - Documentos por Unidades';
      break;
...
<div id="container" style="margin-left: 3%;">
	<div id="infosei" style="padding: 5px 0px 5px 0px; margin-bottom: 20px; margin-right:5px; width: 30%; float: left; text-align: center;border: 2px solid #cecece;">
		<span style="font-size: 12pt;">Documentos Internos&nbsp;</span><br><span style="font-size: 14pt; font-weight: bold;"><?php echo $docInternos; ?></span>	
	</div>

	<div id="infosei" style="padding: 5px 0px 5px 0px; margin-bottom: 20px; margin-right:5px; width: 30%; float: left; text-align: center;border: 2px solid #cecece;">
		<span style="font-size: 12pt;">Documentos Externos&nbsp;</span><br><span style="font-size: 14pt; font-weight: bold;"><?php echo $docExternos; ?></span>	
	</div>

	<div id="infosei" style="padding: 5px 0px 5px 0px; margin-bottom: 20px; margin-right:5px; width: 30%; float: left; text-align: center;border: 2px solid #cecece;">
		<span style="font-size: 12pt;">Total de Documentos &nbsp;</span><br><span style="font-size: 14pt; font-weight: bold;"><?php echo $docInternos + $docExternos; ?></span>	
	</div>
</div>
...
gerarTabela($indicadores['quantidadeDocumentosUnidades'], 'Documentos por Unidade', 95, 'Unidade', 'Documentos', '',$dataColeta);
