<?php
  ...
  switch($_GET['acao']){
    ...
    case 'MdNumerosAcessosUsuarios':
      $strTitulo = 'SEI! em N&uacute;meros - Acessos por Usu&aacute;rios';
      break;
...
<div id="container" style="margin-left: 3%;">
	<div id="infosei" style="padding: 5px 0px 5px 0px; margin-bottom: 20px; margin-right:5px; width: 30%; float: left; text-align: center;border: 2px solid #cecece;">
		<span style="font-size: 12pt;">Usu&aacute;rios Internos &nbsp;</span><br><span style="font-size: 14pt; font-weight: bold;"><?php echo $quantUsuarios ; ?></span>	
	</div>

	<div id="infosei" style="padding: 5px 0px 5px 0px; margin-bottom: 20px; margin-right:5px; width: 30%; float: left; text-align: center;border: 2px solid #cecece;">
		<span style="font-size: 12pt;">Usu&aacute;rios Externos &nbsp;</span><br><span style="font-size: 14pt; font-weight: bold;"><?php echo $quantUsuariosExternos; ?></span>	
	</div>

	<div id="infosei" style="padding: 5px 0px 5px 0px; margin-bottom: 20px; margin-right:5px; width: 30%; float: left; text-align: center;border: 2px solid #cecece;">
		<span style="font-size: 12pt;">Total Usu&aacute;rios &nbsp;</span><br><span style="font-size: 14pt; font-weight: bold;"><?php echo $quantUsuarios + $quantUsuariosExternos; ?></span>	
	</div>
</div>
...
gerarTabela($indicadores['quantidadeAcessosUsuarios'], 'Acessos por Usu&aacute;rios', 95, 'Usu&aacute;rios', 'Acessos', '',$dataColeta);
